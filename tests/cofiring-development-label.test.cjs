...
test('host navigation exposes the development label and loads V4 calculation assets',()=>{
  ...
  assert.match(html,/cofiring-core\.js\?v=20260911-calc-layout-v4/);
  assert.match(html,/cofiring-manure-storage\.js\?v=20260911-calc-layout-v4/);
  assert.match(html,/cofiring-settings-storage\.js\?v=20260911-calc-layout-v4/);
  assert.match(html,/cofiring-draft\.js\?v=20260911-calc-layout-v4/);
});

...
const {create,parseTons}=require('../maintenance/cofiring-organic-storage.js');
...
test('different date does not inherit organic usage; return and same-day reload preserve saved entries',async()=>{

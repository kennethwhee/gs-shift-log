...
(function initializeManholeManagementPage() {
  ...
  */
  const DIAGRAM_MARKERS_BY_NO = {
    /*
      V27 exact original-reference coordinates.

      기준 이미지:
      703 x 622 사용자 원본 도면.

      각 좌표는 원본 노란 맨홀의 실제 중심점이다.
      clean 도면은 이 맨홀 심볼만 제거했고
      live Close/Open marker가 정확히 같은 위치를 사용한다.
    */

    1: [{ x: 3.6984, y: 90.2733 }],
    2: [{ x: 12.4467, y: 18.6495 }],
    3: [{ x: 17.8521, y: 26.8489 }],

    4: [{ x: 44.8080, y: 21.3826 }],
    5: [{ x: 44.7368, y: 27.6527 }],
    6: [{ x: 44.7368, y: 34.4855 }],
    7: [{ x: 44.8080, y: 40.9968 }],
    8: [{ x: 44.8080, y: 47.5884 }],
    9: [{ x: 44.9502, y: 53.6977 }],

    10: [{ x: 65.8606, y: 7.0740 }],
    11: [{ x: 65.7183, y: 11.8971 }],
    12: [{ x: 65.7895, y: 17.5241 }],
    13: [{ x: 65.7183, y: 28.2958 }],
    ...
    15: [{ x: 65.7895, y: 38.3441 }],

    16: [{ x: 65.7895, y: 56.8328 }],
    17: [{ x: 65.9317, y: 61.9775 }],
    18: [{ x: 65.7895, y: 66.8006 }],
    19: [{ x: 65.8606, y: 72.5884 }],

    20: [{ x: 31.8634, y: 97.6688 }],

    21: [{ x: 84.1394, y: 36.4952 }],
    22: [{ x: 90.3272, y: 40.3537 }],
    23: [{ x: 87.4822, y: 66.3987 }],
    24: [{ x: 97.5107, y: 59.7267 }],

    25: [{ x: 24.8222, y: 83.0386, ring: "outer" }],
    26: [{ x: 29.8009, y: 83.1190, ring: "outer" }],
    27: [{ x: 34.7795, y: 82.9582, ring: "outer" }],
    28: [{ x: 21.4794, y: 77.7331, ring: "outer" }],
    29: [{ x: 26.9559, y: 59.6463, ring: "outer" }],

    30: [{ x: 24.8222, y: 83.0386, ring: "inner" }],
    31: [{ x: 29.8009, y: 83.1190, ring: "inner" }],
    32: [{ x: 34.7795, y: 82.9582, ring: "inner" }],
    33: [{ x: 21.4794, y: 77.7331, ring: "inner" }],
    34: [{ x: 26.9559, y: 59.6463, ring: "inner" }]
  };

...
(function initializeManholeManagementPage() {
  ...
  */
  const DIAGRAM_MARKERS_BY_NO = {
    /*
      V24 clean base diagram coordinates.

      The yellow source manhole symbols were removed from the
      artwork. These anchors are aligned to the locations where
      the source symbols existed, so only the live status marker
      is rendered on the diagram.
    */
    ...
    10: [{ x: 64.878, y: 8.060 }],
    11: [{ x: 64.340, y: 11.639 }],
    12: [{ x: 64.501, y: 15.194 }],
    13: [{ x: 64.505, y: 24.464 }],
    ...
    15: [{ x: 67.118, y: 31.958 }],

    16: [{ x: 64.647, y: 49.309 }],
    17: [{ x: 64.554, y: 53.864 }],
    18: [{ x: 64.359, y: 58.666 }],
    19: [{ x: 64.372, y: 63.672 }],

    20: [{ x: 35.797, y: 92.695 }],

    21: [{ x: 82.974, y: 29.802 }],
    22: [{ x: 88.355, y: 34.292 }],
    23: [{ x: 85.998, y: 64.243 }],
    24: [{ x: 96.410, y: 53.065 }],

    25: [{ x: 27.835, y: 76.903, ring: "outer" }],
    26: [{ x: 32.722, y: 76.954, ring: "outer" }],
    27: [{ x: 37.774, y: 76.821, ring: "outer" }],
    28: [{ x: 23.744, y: 71.018, ring: "outer" }],
    29: [{ x: 30.773, y: 51.691, ring: "outer" }],

    30: [{ x: 27.835, y: 76.903, ring: "inner" }],
    31: [{ x: 32.722, y: 76.954, ring: "inner" }],
    32: [{ x: 37.774, y: 76.821, ring: "inner" }],
    33: [{ x: 23.744, y: 71.018, ring: "inner" }],
    34: [{ x: 30.773, y: 51.691, ring: "inner" }]
  };

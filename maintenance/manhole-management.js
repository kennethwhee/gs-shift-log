...
(function initializeManholeManagementPage() {
  ...
  */
  const DIAGRAM_MARKERS_BY_NO = {
    /*
      V26 redrawn base diagram coordinates.

      기준:
      - 1254 x 1254 새 도면
      - 기존 노란 맨홀 심볼 없음
      - 빨간 번호와 설비 위치를 기준으로 live marker만 배치
      - 공유 위치는 같은 anchor 사용
    */
    ...
    10: [{ x: 65.630, y: 7.177 }],
    11: [{ x: 65.630, y: 12.121 }],
    12: [{ x: 65.630, y: 17.225 }],
    13: [{ x: 64.593, y: 25.598 }],
    ...
    15: [{ x: 64.354, y: 35.327 }],

    16: [{ x: 64.354, y: 52.153 }],
    17: [{ x: 64.354, y: 57.257 }],
    18: [{ x: 64.354, y: 63.158 }],
    19: [{ x: 64.354, y: 68.581 }],

    20: [{ x: 34.290, y: 95.056 }],

    21: [{ x: 84.928, y: 31.738 }],
    22: [{ x: 88.198, y: 35.885 }],
    23: [{ x: 87.400, y: 59.490 }],
    24: [{ x: 97.608, y: 55.024 }],

    25: [{ x: 26.156, y: 79.266, ring: "outer" }],
    26: [{ x: 31.499, y: 79.266, ring: "outer" }],
    27: [{ x: 36.683, y: 79.266, ring: "outer" }],
    28: [{ x: 23.604, y: 66.986, ring: "outer" }],
    29: [{ x: 28.868, y: 53.828, ring: "outer" }],

    30: [{ x: 26.156, y: 79.266, ring: "inner" }],
    31: [{ x: 31.499, y: 79.266, ring: "inner" }],
    32: [{ x: 36.683, y: 79.266, ring: "inner" }],
    33: [{ x: 23.604, y: 66.986, ring: "inner" }],
    34: [{ x: 28.868, y: 53.828, ring: "inner" }]
  };

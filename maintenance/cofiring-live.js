(function(root){
  ...
  function createPeriod(options={}) {
    ...
    function schedule(){clearTimer?.(timer);timer=null;const d=entry();if(!disposed&&d?.active&&options.isVisible?.()!==false&&setTimer)timer=setTimer(()=>{timer=null;load({force:true});},1000);}

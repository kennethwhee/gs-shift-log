...
Write-Host '===== Phase 2.5 Direct OIS API v5 ====='
Write-Host "Agent: $Agent"
Write-Host "Stable base: $($Stable.FullName)"

$stamp = Get-Date -Format 'yyyyMMdd-HHmmss'
$currentBackup = "$Agent.before-phase25-v5-$stamp.bak"
...
if ($text.Contains('[PHASE2.5 DIRECT V5]')) {
  throw 'Phase 2.5 Direct v5 is already applied.'
}
...
'@
  ...
  try {
    ...
    console.log(
      "[PHASE2.5 DIRECT V5] Silo Level API complete " +
      (
        (
          Date.now() -
          phase25StartedAt
    ...
    console.warn(
      "[PHASE2.5 DIRECT V5] Silo Level direct API failed; using UI fallback:",
...
'@
  ...
  Write-Host ''
  Write-Host '===== Phase 2.5 Direct OIS API v5 applied ====='
